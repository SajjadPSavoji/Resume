...
\newcommand{\mycventry}[3]{
    \cventry{\scriptsize #1}{\mdseries \textcolor{E2Color}{#2}}{}{}{}{ \footnotesize \textcolor{E3Color}{#3}} \smallskip      
...
Passionate researcher/engineer with 4+ years of experience in designing and implementing AI solutions for software products. Technical advisor to 4 ML-driven SMEs and startups. Dedicated to delivering bug-free, scalable and well-documented programs. \medskip
}
...
\cventry{\scriptsize 2024--Now}{\mdseries \textcolor{E2Color}{Senior Computer Vision Researcher, Huawei, Toronto, ON, Canada}}{}{}{}{\footnotesize \textcolor{E3Color}{
    {\scriptsize $\bullet$} Led the perception team to develop solutions for \textbf{6D pose estimation}, \textbf{3D reconstruction}, \textbf{scene graphs}, and \textbf{SLAM}.\\
    {\scriptsize $\bullet$} Designed and integrated algorithms for robot perception, planning, and natural language understanding.}}
\cventry{\scriptsize 2023--2024\\May--May}{\mdseries \textcolor{E2Color}{Technical Advisor \& Applied AI Intern, Vector Institute for AI, Toronto, ON, Canada}}{}{}{}{\footnotesize \textcolor{E3Color}{
    {\scriptsize $\bullet$} Led weekly consultation sessions with 4 SMEs on \textbf{cloud AI} integration, \textbf{model selection}, and strategic \textbf{product design}.\\
    {\scriptsize $\bullet$} Delivered an NLP-focused training workshop on \textbf{model development} and \textbf{deployment} for over 20 startup teams.\\
    {\scriptsize $\bullet$} Developed an assessment tool leveraging \textbf{RAG} and open-source \textbf{LLM prompting} to automatically generate QAs.\\
    {\scriptsize $\bullet$} Boosted end-to-end accuracy by \textbf{10\%} through human evaluation and improved RAG's mean reciprocal rank (MRR) by \textbf{15\%}.\\
    {\scriptsize $\bullet$} Built a \textbf{CI/CD pipeline} on GitHub to seamlessly integrate code and documentation into a fully operational website.}}
\mycventry{2021--2023\\Spet--May}{ML Engineer, Trans-Plan, Toronto, ON, Canada}
    {
        {\scriptsize $\bullet$} Engineered and deployed an \textbf{ML software stack} for multi-target, multi-source object detection, tracking, and segmentation.\\
        {\scriptsize $\bullet$} Elevated object trajectory classification accuracy to \textbf{86\%} in single-camera setups and \textbf{92\%} in multi-camera configurations.\\
        {\scriptsize $\bullet$} Designed an \textbf{interactive GUI} with PyQt5 and OpenGL, facilitating visualization, annotation, and human-in-the-loop feedback.\\
        {\scriptsize $\bullet$} Actively participated in \textbf{code reviews}, \textbf{documentation}, \textbf{code refactoring}, and \textbf{version control} to enhance code quality.
    }
...
%         {\scriptsize $\bullet$} Succeeded in \textbf{forecasting} category traffic-load for a private ISP by \textbf{recurrent neural networks(LSTMs)}.
    ...
    % }
    \mycventry{2019--2019\\July--Sept}{ML Engineer Intern, AVIR Company, Tehran, Iran}
    {
        {\scriptsize $\bullet$} Developed and deployed a \textbf{multi-modal ML software} to translate Iranian Sign Language (ISL) translation from \textbf{video to text}.\\
        {\scriptsize $\bullet$} Extracted features from body and face key-points, trained \textbf{seq-2-seq} models for \textbf{translation} and \textbf{classification}.\\
        {\scriptsize $\bullet$} Elevated classification accuracy from \textbf{82\%} to \textbf{90\%} at the alphabet level and from \textbf{60\%} to \textbf{65\%} at the word level in translation.
    }
...
{\small
\cventry{\scalebox{.98}{\tiny IEEE ITSC 2024}}{\mdseries \textcolor{E2Color}{{\footnotesize Ground Plane Projection for Improved Traffic Analytics at Intersections; S. Pakdamansavoji, J. Elder, et al.}}}{}{}{}{}
\cventry{\scalebox{.98}{\tiny IEEE WACV 2024}}{\mdseries \textcolor{E2Color}{{ \footnotesize A Multi-Camera/LiDAR, All-Weather, Day/Night Intersection Traffic Dataset; K. Bhargava, S. Pakdamansavoji, et al. {\tiny(submitted)}}}}{}{}{}{}
}
\smallskip
...
% }
\mycventry{2023-2024\\May-May}{\href{}{Structured QA with Retrieval-Augmented Generation | Vector Institute in AI}}{
    {\scriptsize $\bullet$} Created an automated QA system utilizing \textbf{GPT-4} and \textbf{LaMMA2} to streamline the processing of technical SOW documents.\\
    {\scriptsize $\bullet$} Designed and developed a robust \textbf{RAG pipeline} and integrated LLMs for \textbf{structured generation} of QAs in JSON format.\\
    {\scriptsize $\bullet$} Implemented advanced \textbf{hierarchical summarization} techniques, enhancing context accuracy and relevance for LLM inputs.\\
    {\scriptsize $\bullet$} Collaborated on \textbf{system integration and testing}, achieving a \textbf{10\%} increase in content precision with human evaluation.
}

\mycventry{2021-2023\\Sept-May}{\href{}{3D Multi-Camera Multi-Object Turning Movement Counts | Trans-Plan}}{
    {\scriptsize $\bullet$} Executed data cleaning, transformation, feature engineering, and camera calibration on a \textbf{large proprietary dataset}.\\
    {\scriptsize $\bullet$} Architected an open-sourced \textbf{ML software stack} for object detection, tracking, segmentation, pose estimation and classification.\\
    {\scriptsize $\bullet$} Effectively executed \textbf{distributed multi-GPU fine-tuning and inference} on a vision foundation model (InternImage).\\
    ...
    {\scriptsize $\bullet$} Improved tracking MOTA metric by \textbf{28\%} and enhanced trajectory classification accuracy from \textbf{80\%} to \textbf{92\%}.
}

\mycventry{2021-2022\\Dec-May}{\href{}{Synthetic Face Generation Based on Celebrity Faces | AVIR Company}}{
    {\scriptsize $\bullet$} Conducted a performance comparison of \textbf{generative models} on face generation tasks using the \textbf{CelebA public dataset}.\\
    {\scriptsize $\bullet$} Trained a range of models, including \textbf{GANs}, \textbf{Normalizing Flow} (RealNVP), \textbf{Autoencoders} (VAE), and \textbf{diffusion} models.\\
...
\begin{multicols}{2}
    ...
    { \footnotesize
        \cventry{\scriptsize 2021--2024}{\mdseries \textcolor{E2Color}{\scalebox{.85}{MSc in Computer Science, York University, Canada. GPA 8.6/9}}}{}{}{}{}
        \cventry{\scriptsize 2016--2021}{\mdseries \textcolor{E2Color}{\scalebox{.85}{BSc in Electrical \& Computer Eng, University of Tehran, Iran}}}{}{}{}{}
        ...
        \faltcventry{2017-2018}{Founders Scholarship, University of Tehran}
        }
        % \faltcventry{2021}{Lassonde Entrance Scholarship, York University}
        % \faltcventry{2018}{Founders Scholarship, University of Tehran}
        \SectionSmall{SKILLS}
        {\footnotesize
        \cvitem{\scalebox{.88}{\textbf{Programming}}}{Python{\tiny(advance)}, C++{\tiny(advance)}, C, Java, MATLAB, Bash}
        \cvitem{\scalebox{.88}{\textbf{Frameworks}}}{Pytorch, Tensorflow, Keras, JAX, GCP, OpenAI}
        \cvitem{\scalebox{.88}{\textbf{Libraries}}}{OpenCV, OpenMMLab, TensorRT, ONNX, Pillow}
        \cvitem{}{Scikit-learn, NLTK, HuggingFace, spaCy, Matplotlib}
        \cvitem{}{Numpy, Pandas, Seaborn, Docker, Git, Jupyter}
        \cvitem{\scalebox{.88}{\textbf{Soft Skills}}}{Communication, Creativity, Teamwork, Management}
        \cvitem{}{Continuous Learning, Analytical Thinking, Empathy}
        \cvitem{\scalebox{.88}{\textbf{Languages}}}{English {\tiny(fluent)}, Farsi {\tiny(native)}, Arabic {\tiny(intermediate)}}
