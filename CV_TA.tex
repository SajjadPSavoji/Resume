...
Enthusiastic master's student with a strong background in applied machine learning and software development. Experienced in areas like computer vision, natural language processing, generative models, and forecasting. I'm dedicated to exploring innovative and effective ways to teach complex material, ensuring efficient and accurate understanding for a broad audience. \medskip
}
...
\mycventry{2023--2023\\May--Dec}{Applied AI Intern, Vector Institute for AI, Toronto, Canada}
    ...
    {
        {\scriptsize $\bullet$} Contributed to a \textbf{ML integrated software} executing \textbf{multi-target multi-source object forecasting}.\\
...
\section{TEACHING ASSISTANT ROLES}
\TAcventry{2023 - F}{\textbf{Neural Networks and Deep Learning (CSC413)}, University of Toronto, Toronto, CA}

% \TAcventry{2023 - F}{\textbf{Applied Cryptography}, York University, Toronto, CA}

\TAcventry{2023 - S}{\textbf{Advanced Object Oriented Programminig}, York University, Toronto, CA}

\TAcventry{2023 - S}{\textbf{Into to Object Oriented Programminig}, York University, Toronto, CA}

\TAcventry{2021 - 3}{\textbf{Software Tools} (2 semesters), York University, Toronto, CA}

\TAcventry{2022 - W}{\textbf{Design and Analysis of algorithms}, York University, Toronto, CA}

\TAcventry{2022 - F}{\textbf{Data Mining}, York University, Toronto, CA}

\TAcventry{2020 - 2}{\textbf{Neural Networks and Deep Learning} (4 semesters), University of Tehran, Tehran, Iran}

\TAcventry{2020 - 1}{\textbf{Machine Learning} (2 semesters), University of Tehran, Tehran, Iran}

\TAcventry{2020 - F}{\textbf{Pattern Recognition}, University of Tehran, Tehran, Iran}

\TAcventry{2020 - W}{\textbf{Intelligent systems}, University of Tehran, Tehran, Iran}

\TAcventry{2020 - W}{\textbf{Digital Signal Processing} (3 semesters), University of Tehran, Tehran, Iran}

% \TAcventry{2019 - 21}{\textbf{Communication Systems I} (3 semesters), University of Tehran, Tehran, Iran}

\TAcventry{2019-- 20}{\textbf{Engineering Probability and Statistics} (2 semesters), University of Tehran, Tehran, Iran}

% \TAcventry{2019 - F}{\textbf{Electronics I}, University of Tehran, Tehran, Iran}
\medskip
...
\mycventry{Jun'22}{\href{}{Multi-Camera Vehicle and Pedestrain Tracking}}{
    ...
    {\scriptsize $\bullet$} Estimated \textbf{camera extrinsic} in intrinsic to reproject bbox centers on the intersection ground plane\\
    {\scriptsize $\bullet$} Optimized a novel dynamic programming 2D curve \textbf{matching algorithm} to estimate trajectory similarity\\
