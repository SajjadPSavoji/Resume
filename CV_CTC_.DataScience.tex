...
\mycventry{2021--2023\\Spet--Aug}{Research Assistant, Center of Vision Research (CVR), York University}
    {
        {\scriptsize $\bullet$} Wrote data-driven machine learning pipe-line to execute multiple deep learning object detection models\\
        {\scriptsize $\bullet$} Deployed complex machine learning solutions for object tracking on structured video dataset\\
        ...
        {\scriptsize $\bullet$} Provided business insight using data-analytics and visualization to industry partners
    }
\mycventry{2020--2021\\Sept--July}{Research Assistant, Machine Learning Lab, University of Tehran}
    {
        ...
        {\scriptsize $\bullet$}  Automating visualization, training, testing, and comparison of experiments using bash scripts \\
        {\scriptsize $\bullet$}  Presented complex reports on data/feature separation flow in the trained models
...
\mycventry{2019--2020\\Sept--Sept}{Student Researcher, Computer Networks Lab, University of Tehran}
    {
        {\scriptsize $\bullet$} Extracted, transformed, and process internet data into a closed-source unstructured web dataset\\
        {\scriptsize $\bullet$} Adopted RNNs (LSTMs) for user level resource management and allocation strategy\\
...
\mycventry{Jun'22}{\href{}{ML Adoptation for Traffic Analytics at Intersections}}{
    {\scriptsize $\bullet$} Data cleaning, transformation, and processing on large video datasets to remove non-linear distortion\\
    {\scriptsize $\bullet$} Distributed training and inference of deep learning object-trackers on multiple GPUs\\
    {\scriptsize $\bullet$} Implemented an open-source business-specific data visualization tool for annotation\\
    {\scriptsize $\bullet$} Proposed a data-driven classification method to process vehicle trajectories\\
...
\mycventry{July'21}{\href{}{Machine Translation Using Transformers}}{
    {\scriptsize $\bullet$} Preprocessing, Cleaning, and visualization of bilingual text data\\
    {\scriptsize $\bullet$} Fine tuning Transformers(BERT) for English to Persian translation\\
    {\scriptsize $\bullet$} Reported model performance via multiple complex scores and charts
    }
...
\cvitem{Tools}{Tensorflow, Keras, Pytorch, Scikit-learn, Numpy, Pandas, NLTK, Jupyter, HuggingFaces, matplotlib}
