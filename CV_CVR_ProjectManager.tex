...
\mycventry{2021--2023\\Spet--Aug}{Research Assistant, Center of Vision Research (CVR), York University}
    {
        ...
        {\scriptsize $\bullet$} Maintained a well structure code-base used to facilitate experiments within multiple projects and teams
...
\mycventry{2020--2021\\Sept--July}{Research Assistant, Machine Learning Lab, University of Tehran}
    {
        {\scriptsize $\bullet$}  Created customized layers and cost-functions for training representation learning DNNs on CFAR dataset\\
...
\mycventry{2022--2023\\Oct--Jan}{VP External, Iranian Graduate Student Association at YU (IGSAYU)}
    {
        ...
        {\scriptsize $\bullet$} Communication with the student body to advertise event and providing feedback
    }
...
\begin{multicols}{2}
    ...
    \SectionTight{AWARDS}
        \faltcventry{\scriptsize Sep 2022}{VISTA Graduate Scholarship, CVR}
        \faltcventry{\scriptsize Apr 2021}{Vector Scholarship in AI, Vector Institute}
        \faltcventry{\scriptsize Jun 2021}{Lassonde Entrance Scholarship, York University}
