...
An enthusiastic scientist well-versed in applied machine learning and software development, I've delved into diverse areas like computer vision, sentiment analysis, and sequence prediction. My latest passion? scalable AI software development. \medskip
}
...
\mycventry{2023--2023\\May--Dec}{Applied AI Intern, Vector Institute for AI, Toronto, Canada}
    {
        {\scriptsize $\bullet$} Held \textbf{NLP workshop} for \textbf{20+ ML Associates}, covering from basics like preprocessing to \textbf{transformers} fine turning.\\
        {\scriptsize $\bullet$} Held Data Readiness and Model Deployment workshop for \textbf{40+ technical staff} coming from \textbf{20+ SMEs}.\\
        {\scriptsize $\bullet$} Developed a novel maximized-learning platform called "Booklet" leveraging \textbf{CI/CD}, \textbf{Jupyter}, and \textbf{Google Cloud}.
    }
...
\mycventry{2020--2021\\Sept--July}{Engineer, Machine Learning Lab, University of Tehran, Tehran, Iran}
    {
...
\mycventry{2019--2020\\Sept--Sept}{Engineer, Computer Networks Lab, University of Tehran, Tehran, Iran}
    {
    ...
    \mycventry{2019--2019\\July--Sept}{Intern, AVIR Company, Tehran, Iran}
    {
