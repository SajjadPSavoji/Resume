...
An enthusiastic master student, with interest in research administration and managing industrial projects with a focus on applied ML and AI. I have experience applying ML to computer vision and NLP applications and managing medium-sized teams working on the same areas. I have effective communication skills resulted by past leadership roles in non-profitable organizations.\medskip
}
...
\mycventry{2021--2023\\Spet--Aug}{Research Assistant, Center of Vision Research (CVR), York University}
    {
        {\scriptsize $\bullet$} Designed end-to-end machine learning software to execute multiple deep learning object tracking models\\
        {\scriptsize $\bullet$} Developed a well structure code-base used to assist experiments within multiple projects and teams
        % {\scriptsize $\bullet$} Fine-tuned deep neural networks for appearance feature extraction via transfer learning
        % {\scriptsize $\bullet$} Adapting state-of-the-art deep learning prototypes to project needs(eg, pedestrian vs vehicle tracking) 
...
\mycventry{2020--2021\\Sept--July}{Research Assistant, Machine Learning Lab, University of Tehran}
    {
        {\scriptsize $\bullet$}  Identified a novel use-case for an existing separation metric used for training a contrastive network\\
...
\mycventry{2019--2020\\Sept--Sept}{Student Researcher, Computer Networks Lab, University of Tehran}
    {
        {\scriptsize $\bullet$} Extracted, transformed, and analyzed real internet data into a closed-source unstructured web dataset\\
        {\scriptsize $\bullet$} Deployed recurrent neural networks(RNN) eg. LSTMs for User-behavior forecasting as the industrial use-case
...
\mycventry{2019--2019\\July--Sept}{Deep Learning Intern, AVIR Company}
{
    ...
    {\scriptsize $\bullet$} Provided literature reviews and identified best practices for ISL translation
}
...
\mycventry{2022--2023\\Jun--Jan}{Committee Member, CUPE Toronto District Council}{
    ...
    \mycventry{2022--2023\\Jun--Jan}{Head of Logistics and Operation, MITx}{
        {\scriptsize $\bullet$} Responsible for organizing the MITx Toronto Health Hackethon focusing on logistics and operation\\
...
\mycventry{2022--2023\\Oct--Jan}{VP External, Iranian Graduate Student Association at YU (IGSAYU)}
    {
        {\scriptsize $\bullet$} Arranging collaboration with student comities in the GTA promoting unity and equity for persian students\\
        {\scriptsize $\bullet$} Communicating with the student body of York University to advertise event and provide feedback to exec board
    }
\mycventry{2021--2022\\Oct--Oct}{Student Represantative, Vector Institute in AI}{
    {\scriptsize $\bullet$} Communicating with York University students regarding Vector's opportunities and events\\
    {\scriptsize $\bullet$} Providing feedback on registration and engagement strategies as the student representative
    }
...
\cvitem{Tools}{MS Office, GSuite, \LaTeX, MS Teams, Scikit-learn, Numpy, NLTK, OpenCV, Jupyter, JAX, matplotlib, Pandas}
...
\begin{multicols}{2}
    ...
    \SectionTight{VOLUNTEERING}
        \faltcventry{2022--2023}{Mentor, Capstone Project, York University}{}
        \faltcventry{2023--2023}{Mentor, UNHack, York University}{}
        \faltcventry{2018--2020}{Ambassador, IEEEXteme Hackethon, IEEE }{}
        % \faltcventry{2018--2019}{Ambassador, IEEE MadC, IEEE}{}

    \SectionTight{AWARDS}
        \faltcventry{Sep 2022}{VISTA Graduate Scholarship, CVR}
        \faltcventry{Apr 2021}{Vector Scholarship in AI, Vector Institute}
        \faltcventry{Jun 2021}{Lassonde Entrance Scholarship, York University}
        % \faltcventry{Jan 2018}{Supporter Foundation of University of Tehran Scholorship}
