...
\mycventry{2021--2023\\Spet--Aug}{Research Assistant, Center of Vision Research (CVR), York University}
    {
        {\scriptsize $\bullet$} Designed end-to-end large-scale ML system for multiple deep learning object detection models\\
        {\scriptsize $\bullet$} Deployed scalable machine learning-based solutions for object tracking on structured video dataset\\
        {\scriptsize $\bullet$} Upgraded a  graphical user-interface using OpenGL and PyQt5 for human-in-the-loop feedbacks
...
\mycventry{2020--2021\\Sept--July}{Research Assistant, Machine Learning Lab, University of Tehran}
    {
        ...
        {\scriptsize $\bullet$}  Code review and optimization for faster evaluation of feature separation in CNNs layer
...
\mycventry{Jun'22}{\href{}{Traffic Analytics Software at Intersection}}{
    ...
    {\scriptsize $\bullet$} Implemented a software with GUI to annotated resulting object trajectories on the ground plane\\
...
\mycventry{Nov'21}{\href{}{Sentiment Analysis of tweets using Neural Language Models}}{
    ...
    {\scriptsize $\bullet$} Fine tuned large language models such as BERT and XLnet to recognize hate-speech\\
...
\cvitem{Tools}{Tensorflow, Keras, Pytorch, Scikit-learn, Numpy, Pandas, OpenCV, Jupyter, Linux, matplotlib}
