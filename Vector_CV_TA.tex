...
An enthusiastic master student, with interest in applied machine learning and software development. I have strong theoretical background and through hands-on experience with applying machine learning in several areas such as computer vision, natural language processing, generative models and forecasting. I'm always fascinated with writing reusable and well-structured codes. \medskip
}

\SectionTight{EDUCATION}
\cventry{\scriptsize 2021--2023}{\mdseries \textcolor{E2Color}{Master of Science in Computer Science, York University, Toronto, Canada}}{}{}{}{}
\cventry{\scriptsize 2016--2021}{\mdseries \textcolor{E2Color}{Bachelor of Science in Electrical Engineering, University of Tehran, Tehran, Iran}}{}{}{}{}
\cventry{\scriptsize 2018--2020}{\mdseries \textcolor{E2Color}{Minor in Computer Engineering, University of Tehran, Tehran, Iran}}{}{}{}{}
\medskip

\SectionTight{EXPERIENCE}
\mycventry{2023--2023\\May--Sept}{Applied AI Intern, Vector Institute for AI, Toronto, Canada}
    {
        {\scriptsize $\bullet$} Holding tutorial sessions on applied ML for external companies by preparing technical-educational software examples
    }
\mycventry{2021--2023\\Spet--Jan}{Research Assistant, Center of Vision Research (CVR), York University, Toronto, Canada}
    {
        {\scriptsize $\bullet$} Contributed to a \textbf{ML integrated software} which executes \textbf{multi-target multi-camera object tracking}\\
        {\scriptsize $\bullet$} Presented \textbf{proof-of-concept} and \textbf{prototypes} supporting its applicability in \textbf{industrial setups} eg. super markets\\
        {\scriptsize $\bullet$} Designed a graphical \textbf{user-interface} using OpenGL and PyQt5 for human-in-the-loop feedback and annotation
...
\mycventry{2020--2021\\Sept--July}{Research Assistant, Machine Learning Lab, University of Tehran, Tehran, Iran}
    {
...
\mycventry{2019--2020\\Sept--Sept}{Student Researcher, Computer Networks Lab, University of Tehran, Tehran, Iran}
    {
        {\scriptsize $\bullet$} Extracted, transformed, processed and analyzed \textbf{messy data} form internet into an easy-to-use \textbf{private dataset}\\
        {\scriptsize $\bullet$} Deployed \textbf{deep learning} based packet inspection (DPI) to \textbf{classify} and filter internet traffic into 100 categories\\
        {\scriptsize $\bullet$} Succeeded in \textbf{forecasting} category traffic-load for a major internet service provider by \textbf{recurrent neural networks}
        % supervisor: \href{https://ece.ut.ac.ir/en/~vmansouri}{Vahid Shahmansouri}, Asst.Prof.  
    }
    \mycventry{2019--2019\\July--Sept}{Deep Learning Intern, AVIR Company, Tehran, Iran}
    {
        {\scriptsize $\bullet$} Established a \textbf{multi-modal ML baseline} to translate Iranian Sign Language (ISL) translation from video to text\\
...
%     }
% \mycventry{2022--2023\\Jun--Jan}{Committee Member, CUPE Local 3903 Toronto District Council}{
...
\mycventry{Jun'22}{\href{}{Multi-Camera Vehicle and Pedestrain Tracking}}{
...
\mycventry{Nov'20}{\href{}{Sentence Generation with Long-Short-Term-Memory (LSTM) Networks}}{
...
%     {\scriptsize $\bullet$} Succeeded in building high performance \textbf{generative models(GANs)} to synthesis CIFAR10 dataset\\
%     {\scriptsize $\bullet$} Compared \textbf{DC-GAN}, \textbf{CGAN}, \textbf{AC-GAN} and \textbf{real-NVP} on generated results and real data\\
%     {\scriptsize $\bullet$} Compared the effect of different cost-functions and optimizers on \textbf{synthesis quality}
% }
...
\SectionTight{TECHNICAL SKILLS}
        {\small
        \cvitem{Languages}{Python{\tiny(advance)}, C++{\tiny(advance)}, C{\tiny(intermediate)}, MATLAB{\tiny(intermediate)}, Bash Script{\tiny(intermediate)}}
        \cvitem{Tools}{Pytorch, Tensorflow, Keras, JAX, Sklearn, Numpy, NLTK, OpenCV, Pandas, JupyterNotebook, HuggingFaces}
...
\medskip
        ...
        \SectionTight{AWARDS}
        \faltcventry{2021}{Vector Master Scholarship in AI, Vector Institute \tiny(17500 CAD)}
        \faltcventry{2022}{VISTA Graduate Scholarship, CVR \tiny(16666 CAD)}
        \faltcventry{2021}{Lassonde Entrance Scholarship, York University \tiny(6000 CAD)}
...
\mycventry{Sep'21--Apr'23}{\textbf{Software Tools} (2 semesters), York University, Toronto, CA}
{
    {\scriptsize $\bullet$} Held hands-on sessions, designed projects, graded computer assignments, and provided individual feedback.
    % \emph{Instructor:} \href{https://ca.linkedin.com/in/huiwang0123}{\underline{Hui Wang}, Reasearch Assoc, York University}
}
\mycventry{Sep'22--Dec'22}{\textbf{Design and Analysis of algorithms}, York University, Toronto, CA}
{
    {\scriptsize $\bullet$} Held in-person tutorials, office hours, QA sessions, and graded assignments. 
...
\mycventry{Jan'22--Apr'22}{\textbf{Data Mining}, York University, Toronto, CA}
{
    {\scriptsize $\bullet$} Graded computer projects, assignment, and written theoretical exams.
...
\mycventry{Sep'20--Dec'22}{\textbf{Neural Networks and Deep Learning} (4 semesters), University of Tehran, Tehran, Iran}
{
    {\scriptsize $\bullet$} Designed the final computer project related to Generative Adversarial Networks.\\
    {\scriptsize $\bullet$} Prepared hands-on jupyter notebook tutorials on how to get started with pytorch.\\
    {\scriptsize $\bullet$} Prepared recorded lectures on how to use JAX for implementing HW agnostic modules.
}
\mycventry{Sep'20--Feb'21}{\textbf{Machine Learning} (2 semesters), University of Tehran, Tehran, Iran}
{
    {\scriptsize $\bullet$} Designed the final computer project related to cancer prediction.\\
    {\scriptsize $\bullet$} Prepared hands-on jupyter notebook tutorials on how to get started with Sklearn.
...
% \mycventry{Feb'20--Jun'20}{Teaching assistant for Pattern Recognition, Univer}
% {
%     Held hands-on session, designed 2 homeworks and marked them, designed 3 quizzes and marked them, graded their final project, suggested questions for midterm and final exam
% }
\mycventry{Feb'20--Jun'20}{\textbf{Pattern Recognition}, University of Tehran, Tehran, Iran}
{
    {\scriptsize $\bullet$} Held hands-on session, designed 2 homeworks and 3 quizzes.
    % \emph{Instructor:} \href{https://ece.ut.ac.ir/en/~dehaqani}{\underline{Mohammadreza Abolghasemi}, Asst.Prof,  University of Tehran}
}
\mycventry{Sep'20--Feb'21}{\textbf{Intelligent systems}, University of Tehran, Tehran, Iran}
{
    {\scriptsize $\bullet$} Designed 6 final projects, marked them, and provided individual assessment.
...
\mycventry{Feb'20--Feb'21}{\textbf{Digital Signal Processing} (3 semesters), University of Tehran, Tehran, Iran}
{
    {\scriptsize $\bullet$} Designed 4 computer assignments, one analytical assignment and organized other TAs.
    % \emph{Instructor:} \href{https://scholar.google.com/citations?hl=en&user=Yqzkf3UAAAAJ}{\underline{Hadi Amiri}, Asst.Prof, University of Tehran}\\
    % \emph{Instructor:} \href{https://scholar.google.com/citations?user=VspDmN8AAAAJ&hl=en}{\underline{Majid Badieirostami}, Asst.Prof, University of Tehran}\\
    % \emph{Instructor:} \href{https://scholar.google.com/citations?user=atXIykYAAAAJ&hl=en}{\underline{Mohammadali Akhaee}, Asst.Prof, University of Tehran}
}
\mycventry{Sep'19--Feb'21}{\textbf{Communication Systems I} (3 semesters), University of Tehran, Tehran, Iran}
{
    {\scriptsize $\bullet$} Designed 4 homeworks all of which include implementation part, 4 computer assignments, and  assessed students.
    % \emph{Instructor:} \href{https://scholar.google.com/citations?user=fCts8c0AAAAJ&hl=en}{\underline{Maryam Sabaghian}, Asst.Prof, University of Tehran}\\
    % \emph{Instructor:} \href{https://scholar.google.com/citations?hl=en&user=Yqzkf3UAAAAJ}{\underline{Hadi Amiri}, Asst.Prof, University of Tehran}
}

\mycventry{Feb'19--Feb'20}{\textbf{Engineering Probability and Statistics} (2 semesters), University of Tehran, Tehran, Iran}
{
    {\scriptsize $\bullet$} Designed homeworks and computer assignments, held Q\&A session.
    % \emph{Instructor:} \href{https://ece.ut.ac.ir/en/~dehaqani}{\underline{Mohammadreza Abolghasemi}, Asst.Prof, University of Tehran}
}

\mycventry{Feb'19--Jun'19}{\textbf{Electronics I}, University of Tehran, Tehran, Iran}
{
    {\scriptsize $\bullet$} Marked student's homeworks, mentored them in the problem-solving procedure.
    % \emph{Instructor:} \href{https://scholar.google.com/citations?hl=en&user=T7fVw08AAAAJ}{\underline{Mohammadreza Kolahdooz}, Asst.Prof, University of Tehran}
}
\medskip
...
\faltcventry{Oct-Feb 23}{Logistics and Operation, Toronto Health Datathon, University of Toronto}
\faltcventry{Dec 21-22}{Student representative, Vector Institute for Artificial Intelligence}
\faltcventry{Jun-Dec 22}{Committee Member, CUPE Local 3903 Toronto District Council, Toronto}
\faltcventry{Jan-Mar 23}{VP External, Iranian Graduate Student Association at York Universit, York University}
\faltcventry{Oct-Dec 22}{Mentor, Capston Project, Lassonde School of Engineering, York University}
\faltcventry{Nov-Oct 22}{Mentor, UN Hack, Lassonde School of Engineering, York University}
\faltcventry{Apr 19-20}{Ambassador for IEEEmadC Competition, IEEE}
\faltcventry{Oct 18-20}{Ambassador for IEEEXtreme Programming Competition (12.0, 13.0, and 14.0), IEEE}
\faltcventry{Apr 18-19}{Vice Chair, IEEE University of Tehran Student Branch, University of Tehran}
