...
As an avid scientist with expertise in applied machine learning and software development, I'm experienced in open-source, on-premise LLM prompting and eager to expand my skills through an Amii internship.\medskip
}


\SectionTight{EXPERIENCE}
\mycventry{2024--2024\\Jan--Feb}{Technical Advisor, Vector Institute for AI, Toronto, Canada}
    {
        {\scriptsize $\bullet$} Provide technical expertise on \textbf{LLM adoption} for \textbf{3 SMEs}: Profound Impact Corp, LVS AI Inc, and Giant Step Inc.\\
...
\mycventry{2023--2023\\May--Dec}{Applied AI Intern, Vector Institute for AI, Toronto, Canada}
    {
        ...
        {\scriptsize $\bullet$} Designed a structure QA generation tool utilizing \textbf{Chain of Thought Prompting} on \textbf{Llama2} and \textbf{GPT4}.\\
