...
\mycventry{2021--2023}{MSc in Computer Science, York University}{Supervisor: \href{https://www.elderlab.yorku.ca/jelder/}{James Elder Professor and York Research Chair in Human and Computer Vision}\\ GPA: 8.6/9(A+)}
\mycventry{2016--2021}{BSc in Electrical Engineering, University of Tehran}{GPA: 17.57/20 (3.77/4)}
\mycventry{2018--2020}{Minor Degree in Computer Engineering, University of Tehran}{GPA: 18.22/20 (4/4), ranked $2^{nd}$}
...
{
    \cvitem{Sep 2022}{VISTA Graduate Scholarship, Vision: Science to Application}
...
\cvitem{Tools}{Tensorflow, Keras, Pytorch, Scikit-learn, Numpy, Pandas, OpenCV, Jupyter}
...
\mycventry{Sep'21--Aug'23}{RA, Center of Vision Research (CVR), York University}
    {
        objectives: Traffic flow analysis on surveillance visual data at crowded intersections\\
        supervisor: \href{https://www.elderlab.yorku.ca/jelder/}{James Elder}, Prof.  
    }
\mycventry{Sep'20--Jul'21}{RA, Machine Learning Lab, University of Tehran}
    {
        objectives: Manifold learning using a novel ranking loss (continuous separation index) for DNNs\\
...
\mycventry{Sep'19--Sep'20}{RA, Computer Networks Lab, University of Tehran}
    {
        objectives: User-level activity and bandwidth prediction using Long-Short-Term-Memory NNs\\
...
\mycventry{Jul'19--Sep'19}{Research Intern, Secure Communication Lab, University of Tehran}
    {
        objectives: Iranian Sign Language (ISL) translation from visual footage to text using recurrent NNs\\
...
\mycventry{Sep'22--Dec'22}{TA, Design and Analysis of algorithms}
{
    \emph{Obligation:} held in-person tutorials and graded assignments\\
...
\mycventry{Sep'20--Dec'22\\\textbf{\footnotesize graduate course}}{TA, Neural Networks and Deep Learning (4 semesters)}
{
...
\mycventry{Feb'20--Feb'21\\\textbf{\footnotesize graduate course}}{TA, Digital Signal Processing (3 semesters)}
{
...
\mycventry{Sep'19--Feb'21}{TA, Communication Systems I (3 semesters)}
{
...
\mycventry{Feb'19--Feb'20}{TA, Engineering Probability and Statistics (2 semesters)}
{
