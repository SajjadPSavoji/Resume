...
\mycventry{2021--2023\\Spet--Aug}{Research Assistant, Center of Vision Research (CVR), York University}
    {
        {\scriptsize $\bullet$} Wrote end-to-end software in python to execute multiple deep learning object detection models\\
...
\mycventry{Nov'21}{\href{}{Sentiment Analysis of tweets using Large Language Models}}{
